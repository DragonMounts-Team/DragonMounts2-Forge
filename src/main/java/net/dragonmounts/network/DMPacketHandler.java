...
public class DMPacketHandler {
    ...
    public static void initClient() {
        ...
        CHANNEL.registerMessage(3, SInitCooldownPacket.class, SInitCooldownPacket::encode, SInitCooldownPacket::new, ClientHandler::handle);
        CHANNEL.registerMessage(4, SSyncCooldownPacket.class, SSyncCooldownPacket::encode, SSyncCooldownPacket::new, ClientHandler::handle);
        CHANNEL.registerMessage(5, SRiposteEffectPacket.class, SRiposteEffectPacket::encode, SRiposteEffectPacket::new, ClientHandler::handle);
    ...
    public static void initServer() {
        ...
        CHANNEL.registerMessage(3, SInitCooldownPacket.class, SInitCooldownPacket::encode, SInitCooldownPacket::new, DMPacketHandler::placeholder);
        CHANNEL.registerMessage(4, SSyncCooldownPacket.class, SSyncCooldownPacket::encode, SSyncCooldownPacket::new, DMPacketHandler::placeholder);
        CHANNEL.registerMessage(5, SRiposteEffectPacket.class, SRiposteEffectPacket::encode, SRiposteEffectPacket::new, DMPacketHandler::placeholder);
        CHANNEL.registerMessage(6, CRideDragonPacket.class, CRideDragonPacket::encode, CRideDragonPacket::new, CRideDragonPacket::handle);
    }
}
