 ...
 */
@OnlyIn(Dist.CLIENT)
public class ScreenDragonCore extends ContainerScreen<ContainerDragonCore> {
    private static final ResourceLocation TEXTURE_LOCATION = prefix("textures/gui/dragon_core.png");

    public ScreenDragonCore(ContainerDragonCore menu, PlayerInventory playerInventory, ITextComponent title) {
