...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<DragonEggEntity>> DRAGON_EGG = register("dragon_egg", DragonEggEntity::new, EntityClassification.MISC, 0.8F, 0.8F);
    public static final RegistryObject<EntityType<TameableDragonEntity>> TAMEABLE_DRAGON = register("dragon", TameableDragonEntity::new, EntityClassification.MISC, 0.8F, 0.8F);
    ...
    public static void addEntityAttributes(EntityAttributeCreationEvent event) {
        event.put(DRAGON_EGG.get(), DragonEggEntity.registerAttributes().build());
