...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<EntityCarriage>> ENTITY_CARRIAGE = register("carriage", (type, world) -> new EntityCarriage(world), EntityClassification.MISC, 0.8F, 0.8F);
