 ...
 */
public class ContainerDragonCore extends Container {
    private final IInventory container;

    public ContainerDragonCore(int containerId, PlayerInventory playerInventory, PacketBuffer extraData) {
    ...
    public ContainerDragonCore(int containerId, PlayerInventory playerInventory, IInventory container) {
