 ...
 */
public class ContainerDragonShulkerBox extends Container {
    private final IInventory container;

    public ContainerDragonShulkerBox(int containerId, PlayerInventory playerInventory, PacketBuffer extraData) {
    ...
    public ContainerDragonShulkerBox(int containerId, PlayerInventory playerInventory, IInventory container) {
        super(ModContainers.DRAGON_SHULKER_BOX.get(), containerId);
