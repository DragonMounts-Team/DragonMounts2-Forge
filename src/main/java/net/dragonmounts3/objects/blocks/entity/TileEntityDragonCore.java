 ...
 */
public class TileEntityDragonCore extends LockableLootTileEntity implements ITickableTileEntity {
    ...
    private void moveCollidedEntities() {
        if (this.level != null) {
            ...
            if (blockstate.getBlock() instanceof BlockDragonCore) {
