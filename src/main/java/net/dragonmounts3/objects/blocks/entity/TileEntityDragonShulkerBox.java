 ...
 */
public class TileEntityDragonShulkerBox extends LockableLootTileEntity implements ITickableTileEntity {
    private static final String TRANSLATION_KEY = "container.dragonmounts.dragon_shulker_box";
    ...
    public TileEntityDragonShulkerBox() {
        super(ModTileEntities.DRAGON_SHULKER_BOX.get());
    }
    ...
    private void moveCollidedEntities() {
        if (this.level != null) {
            ...
            if (blockstate.getBlock() instanceof BlockDragonShulkerBox) {
    ...
    protected Container createMenu(int id, @Nonnull PlayerInventory player) {
        return new ContainerDragonShulkerBox(id, player, this);
    }
