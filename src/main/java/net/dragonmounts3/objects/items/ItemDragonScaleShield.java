...
public class ItemDragonScaleShield extends ShieldItem implements IDragonTypified {
    private static final String TRANSLATION_KEY = getItemTranslationKey("dragon_scale_shield");

    protected DragonType type;

    protected final DragonScaleMaterial material;

    public ItemDragonScaleShield(
