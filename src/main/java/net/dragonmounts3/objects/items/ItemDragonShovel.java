...
public class ItemDragonShovel extends ShovelItem implements IDragonTypified {
    private static final String TRANSLATION_KEY = getItemTranslationKey("dragon_shovel");
